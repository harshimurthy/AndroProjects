 ...
 */
public class SetTaskFragment1 extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View contentView = getActivity().getLayoutInflater().inflate(R.layout.set_team2_layout, null);

        //Get any Views you need (Any local variables accessed from inside an anonymous inner class must be final)
        final Spinner taskSelection = (Spinner) contentView.findViewById(R.id.task_selection2);
        final EditText scoreSelection=(EditText)contentView.findViewById(R.id.score2);
